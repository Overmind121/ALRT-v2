...
export default function CallInfo({navigation}){
    ...
    //     calcDiff();
    //     // console.log(call);
    //     // console.log("calculated Diff: "+call.value);
    //     // console.log("calculated Expected: "+call.expected);
    // }
    ...
    return(
        ...
        <View style={styles.container}>
                ...
                <Text style={styles.display}>Expected Call:</Text>
                <Text style={styles.display}>{call.expected}</Text>
                <Text style={styles.display}>Call Difference:</Text>
                <Text style={styles.display}>{call.value}</Text>
                <TextInput
